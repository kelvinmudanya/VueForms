        ...
        <div class = "row">
            <div class = "col-xl-12">
                ...
                <div class = "form-group">
                    ...
                    <input type="email" id="email" class = "form-control" v-model.lazy="formData.email"/>
                ...
                <div class = "form-group">
                    ...
                    <textarea type="text" id="message" rows = '3' class = "form-control" v-model.lazy="formData.message"/>
